...
@section('content')
<form action="{{route('consoles.index')}}" method="post" enctype="multipart/form-data" class="submit-form">
    @csrf
    ...
    <div class="form-group mb-3">
        <label for="title">Verzió</label>
        <input type="text" class=" form-control input-dark" id="version" name="version" placeholder="Verzió">
    </div>
